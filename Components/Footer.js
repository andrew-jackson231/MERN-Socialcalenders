          ...
          <div className="container text-center text-md-start mt-5">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                />
                <p><i className="fas fa-home mr-3"></i> [Your Location]</p>
                <p><i className="fas fa-envelope mr-3"></i> [Your Email]</p>
                <p><i className="fas fa-phone mr-3"></i> [Your Phone]</p>
                <p><i className="fas fa-print mr-3"></i> [Your Fax]</p>
              </div>
